...
inputText = ["Game 1: 3 green, 1 blue, 3 red; 3 blue, 1 green, 3 red; 2 red, 12 green, 7 blue; 1 red, 4 blue, 5 green; 7 green, 2 blue, 2 red"
...
def gameStrToList(aStr: str):
    ...
    while i <= (len(aStr) - 1):
        iSingleSet += aStr[i]
        if aStr[i] == ";":
            iSingleGame.append(iSingleSet[:-1])
            iSingleSet = ""
            i += 1
        i += 1
